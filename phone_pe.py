...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\Selvam\OneDrive\Desktop\guvi project\youtube\phonepe\pulse\th.jpg"),width= 500)

    col3,col4= st.columns(2)
    
    with col3:
        st.image(Image.open(r"C:\Users\Selvam\OneDrive\Desktop\guvi project\youtube\phonepe\phone_pe_jdqylg_1604316153853_1604316163519.webp"),width=490)
    ...
    with col6:
        st.image(Image.open(r"C:\Users\Selvam\OneDrive\Desktop\guvi project\youtube\phonepe\PP_LogoSectionDivider.jpg"),width= 500)
    ...
    with tab2:
        ...
        if method_2 == "Map Insurance":
            ...
            with col1:
                ...
                years= st.slider("Select The Year_mi",int(map_insurance["Years"].min()), int(map_insurance["Years"].max()),int(map_insurance["Years"].min()))
            ...
            with col1:
                ...
                years= st.slider("Select The Year",int(map_transaction["Years"].min()), int(map_transaction["Years"].max()),int(map_transaction["Years"].min()))
    ...
    with tab3:
        ...
        if method_3 == "Top Insurance":
            ...
            with col1:
                ...
                years= st.slider("Select The Year_ti",int(top_insurance["Years"].min()), int(top_insurance["Years"].max()),int(top_insurance["Years"].min()))
            ...
            with col1:
                ...
                years= st.slider("Select The Year_tt",int(top_transaction["Years"].min()),int(top_transaction["Years"].max()),int(top_transaction["Years"].min()))
            ...
            with col1:
                ...
                years= st.slider("Select The Year_tu",int(top_user["Years"].min()), int(top_user["Years"].max()),int(top_user["Years"].min()))
